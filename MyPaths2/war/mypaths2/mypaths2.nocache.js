...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "mypaths2" because\n';
  ...
  $wnd.__gwt_activeModules['mypaths2'] = {
    'moduleName' : 'mypaths2',
    'bindings' : function() {
      return {};
    }
 ...
 * "/mypaths2.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['mypaths2'].superdevmode = true;

  var expectedSuffix = '/mypaths2.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + mypaths2 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:mypaths2';
  var devModeSessionKey = '__gwtDevModeSession:mypaths2';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/mypaths2/mypaths2.nocache.js';
  ...
  $wnd.__gwt_activeModules['mypaths2'].canRedirect = true;
  $wnd.__gwt_activeModules['mypaths2'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/mypaths2?user.agent=' + ua + '&_callback=' + callback;
